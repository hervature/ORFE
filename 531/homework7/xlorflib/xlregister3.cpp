...
namespace {
  ...
  // Register the function ORF.WORSTOFDIGITALBSMC
  XLRegistration::Arg OrfWorstOfDigitalBSMCArgs[] = {
	  { "PayoffType", "1: call; -1: put", "XLF_OPER" },
	  { "Strike", "strike", "XLF_OPER" },
	  { "FixingTimes", "the basket observation times", "XLF_OPER" },
	  { "Spots", "spots for each asset", "XLF_OPER" },
	  ...
	  { "Vols", "volatilities for each asset", "XLF_OPER" },
	  { "Correl", "the correlation matrix", "XLF_OPER" },
	  { "McParams", "Default: UrngType=MT19937; PathGenType=EULER; ControlVarType=NONE", "XLF_OPER" },
	  { "NPaths", "The number of Monte-Carlo paths", "XLF_OPER" },
	  { "Headers", "TRUE for displaying the header", "XLF_OPER" }
  };
  XLRegistration::XLFunctionRegistrationHelper regOrfWorstOfDigitalBSMC(
	  "xlOrfWorstOfDigitalBSMC", "ORF.WORSTOFDIGITALBSMC", "Price of a digital call/put option on the worst of a basket of assets in the Black-Scholes model using Monte Carlo.",
	  "ORFLIB", OrfWorstOfDigitalBSMCArgs, 11);
